...
const hotelQuery = next_sanity__WEBPACK_IMPORTED_MODULE_0__.groq`
    *[_type == "hotel"]
`;
async function handler(req, res) {
    const hotels = await _sanity__WEBPACK_IMPORTED_MODULE_1__/* .sanityClient.fetch */ .i3.fetch(hotelQuery);
    res.status(200).json({
        hotels
    });
}
