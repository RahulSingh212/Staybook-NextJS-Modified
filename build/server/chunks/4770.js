...
/* harmony export */   "Op": () => (/* binding */ getBookedHotelDetails),
/* harmony export */   "Xe": () => (/* binding */ bookingConfirmationRedirector),
/* harmony export */   "i": () => (/* binding */ fetchUserPersonalDetails),
/* harmony export */   "w1": () => (/* binding */ hotelBookingHandler)
/* harmony export */ });
/* harmony import */ var _emailjs_browser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7163);
...
/* harmony import */ var _classModels_bookings_bookingDetails__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7160);
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4038);
/* harmony import */ var firebase_firestore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1492);
/* harmony import */ var _firebase__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9819);
...
const bookingConfirmationRedirector = (router, booking_Id, receipt_Id, userBooking)=>{
    router.replace({
...
const getBookedHotelDetails = async (userEmailId, bookingId)=>{
    const docRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.doc)(_firebase__WEBPACK_IMPORTED_MODULE_4__.db, _helper__WEBPACK_IMPORTED_MODULE_2__/* .USER_BOOKINGS_COLLECTION_NAME */ .D4, userEmailId, _helper__WEBPACK_IMPORTED_MODULE_2__/* .BOOKED_ROOMS_COLLECTION_NAME */ .OQ, bookingId);
    const booking = await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.getDoc)(docRef);
    const firestore = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.getFirestore)();
    const bookedRoomsCollectionRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_3__.collection)(firestore, _helper__WEBPACK_IMPORTED_MODULE_2__/* .USER_BOOKINGS_COLLECTION_NAME */ .D4, userEmailId, _helper__WEBPACK_IMPORTED_MODULE_2__/* .BOOKED_ROOMS_COLLECTION_NAME */ .OQ, bookingId, _helper__WEBPACK_IMPORTED_MODULE_2__/* .HOTEL_BOOKINGS_ROOMS_COLLECTION_NAME */ ._w);
    let bookingInfo = new _classModels_bookings_bookingDetails__WEBPACK_IMPORTED_MODULE_1__/* .BookingDetails */ .y();
    let bookedRoomsList = [];
...
const emailHandler = async (userBooking)=>{
    let templateParams = {
        ...
        status: `Amount due: ₹${Math.floor(userBooking.total_Price - userBooking.amount_Paid)}, Pay now to save extra ₹${Math.min(175, 0.05 * userBooking.total_Price)}-`,
        customerContact: "Contact"
    };
    try {
        await _emailjs_browser__WEBPACK_IMPORTED_MODULE_0___default().send("service_pz9e3th", "template_i78ka1b", templateParams, "rxw7da9yaeHbqZ1ou");
    } catch (error) {
        console.log(error);
    }
};
const hotelBookingHandler = async (userBooking)=>{
...
const fetchUserPersonalDetails = async (userBooking)=>{
