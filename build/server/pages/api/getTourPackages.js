...
const tourPackageQuery = next_sanity__WEBPACK_IMPORTED_MODULE_0__.groq`
    *[_type == "package"]
`;
async function handler(req, res) {
    const tourPackages = await _sanity__WEBPACK_IMPORTED_MODULE_1__/* .sanityClient.fetch */ .i3.fetch(tourPackageQuery);
    res.status(200).json({
        tourPackages
    });
}
